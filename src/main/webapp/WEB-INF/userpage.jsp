        ...
        <div class="container-fluid">
            <div class="row all-post">
                ...
                <main class="col-8">
                    ...
                    <form action="/userpageServlet" method="post" class="mb-4 post-method" enctype="multipart/form-data" onsubmit="document.getElementById('myBtn').disabled = true;">
                        <div class="mb-3">
                    ...
                    <c:forEach items="${posts}" var="post">
                        <div class="post mb-4" style="overflow-wrap: break-word; border: 1px solid #ddd; padding: 10px; border-radius: 10px;" data-post-id="${post.post_id}" data-liked="${post.likedByCurrentUser}">
                            ...
                            <!-- Comment form -->
                            <form action="/commentServlet" method="post" class="mb-4 post-method">
                                <div class="mb-3">

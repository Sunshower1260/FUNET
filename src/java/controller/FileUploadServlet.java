...
public class FileUploadServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(FileUploadServlet.class.getName()).info(tempFile.toString());
            // Upload to Cloudinary
            Map uploadResult = CloudinaryAPI.getInstance().uploader().upload(tempFile, ObjectUtils.emptyMap());
